...
#     def test_debug_writes_ad_clips_before_cut(self, tmp_path):
#         seg = self._make_seg()
...
#             with patch("part_io.cli.remote_pipeline._validate_segments"):
#                 with patch(
#                     "part_io.cli.remote_pipeline.run_resolved",
...
#     def test_debug_clip_write_failure_returns_failed(self, tmp_path):
#         seg = self._make_seg()
#         run_result = MagicMock()
#         run_result.returncode = 1
#         with patch("part_io.cli.remote_pipeline.pair_ad_segments", return_value=([seg], [], [])):
#             with patch("part_io.cli.remote_pipeline._validate_segments"):
#                 with patch("part_io.cli.remote_pipeline.run_resolved", return_value=run_result):
#                     result = _pair_and_cut(
#                         "ep001",
#                         tmp_path / "ep.mp3",
#                         output_dir=tmp_path / "out",
