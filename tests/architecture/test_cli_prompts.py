...
Iterates every :class:`~partio.cli.registry.CommandEntry` from
:func:`~partio.cli.registry.discover`, re-uses
:func:`~partio.cli.prompting.required_options` to find required args, and
...
from partio.cli.prompting import required_options
